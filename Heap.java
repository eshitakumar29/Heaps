 ...
 * I though that this assignment gave me a better understanding of map, <br>
 * and how to use the java API in order to find methods to obtains values <br>
 * from it. In addition to this, I though that it was very interesting to <br>
 * use two data structures to store similar and different pieces of <br>
 * information, each having their respective positives and negatives when <br>
 * it came to the time required, or big O.
 */
